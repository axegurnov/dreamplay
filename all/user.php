...
//разбиваем url
	...
	top('Профиль '.$row['login']);
?>
<div class="my_profile">
	<div class="img_my_profile" align="center"><img src="../<?php echo $row['image_profile_url']?>" width="100px" height="100px"></div>
	<div class="name_my_profile" align="center"><?php echo $row['login']?></div>
...
<?php 
	...
	{
		?>
		<center><div style="font-weight: bold" align="center">У пользователя нет видео.</div></center>
		<?
	}
	else
	{
